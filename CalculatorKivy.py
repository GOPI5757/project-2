...
class MyGridLayout(GridLayout):
    def __init__(self, **kwargs):
        ...
        self.calclabel = Label(text="0", font_size=30)
        self.add_widget(self.calclabel)

        # First Row

        self.clearbutton = Button(text="C", font_size=30)
        self.BackButton = Button(text="<--", font_size=30)
        self.percentButton = Button(text="%", font_size=30)
        self.MultiplyButton = Button(text="X", font_size=30)

        # Second Row

        self.SevenButton = Button(text="7", font_size=30)
        self.EightButton = Button(text="8", font_size=30)
        self.NineButton = Button(text="9", font_size=30)
        self.DivideButton = Button(text="/", font_size=30)

        # Third Row

        self.FourButton = Button(text="4", font_size=30)
        self.FiveButton = Button(text="5", font_size=30)
        self.SixButton = Button(text="6", font_size=30)
        self.SubtractButton = Button(text="-", font_size=30)

        # Fourth Row

        self.OneButton = Button(text="1", font_size=30)
        self.TwoButton = Button(text="2", font_size=30)
        self.ThreeButton = Button(text="3", font_size=30)
        self.AddButton = Button(text="+", font_size=30)

        # Fifth Row

        self.ZeroButton = Button(text="0", font_size=24)
        self.DotButton = Button(text=".", font_size=24)
        self.EqualsButton = Button(text="=", font_size=24, background_color = (1,1,0,1))
